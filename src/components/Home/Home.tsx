...
const BLURB_TEXT: string = `Nashville-based software developer with foci on ASP.NET
    Core, Node, and React. Passionate about continuing education, and real-world problem
